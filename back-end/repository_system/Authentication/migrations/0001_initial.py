# Generated by Django 5.0.4 on 2025-02-16 20:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_time', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('department_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Authentication.departmentlist')),
            ],
        ),
        migrations.CreateModel(
            name='Teacher',
