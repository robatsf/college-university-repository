# Generated by Django 5.0.4 on 2025-03-01 06:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allowed_filter_fields', models.TextField(blank=True, default='id,title,author,year,type,availability,created_at,updated_time,department,approved,original_file_path,file_size,file_extension,uploaded_by,disapproval_reason', help_text='Comma separated list of allowed filter fields (e.g. id, title, author, year,', null=True)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_time', models.DateTimeField(auto_now=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disapproval_reason', models.CharField(default=None, max_length=255, null=True)),
