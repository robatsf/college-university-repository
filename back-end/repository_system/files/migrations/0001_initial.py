# Generated by Django 5.0.4 on 2025-02-18 15:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('GET', 'GET'), ('POST', 'POST'), ('PUT', 'PUT'), ('DELETE', 'DELETE')], max_length=10)),
                ('allowed', models.BooleanField(default=False)),
                ('allowed_filter_fields', models.TextField(blank=True, help_text='Comma separated list of allowed filter fields (e.g. name,department)', null=True)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_time', models.DateTimeField(auto_now=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mirror_file_path', models.CharField(blank=True, max_length=1024, null=True)),
